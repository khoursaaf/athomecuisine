                    ...
                    <div class="card" id="card_registration">
                        <div class="card-body">
                            <form action="" method="POST" class="form-signin mt-4">
                                ...
                                <input type="text" name="inputPseudo" id="inputPseudo" class="form-control mb-2 mt-4" placeholder="Pseudo" autofocus>

                                <label for="inputEmail" class="sr-only">E-mail</label>
                                <input type="email" name="inputEmail" id="inputEmail" class="form-control mb-2" placeholder="E-mail" autofocus>

                                <label for="inputPassword" class="sr-only">Mot de Passe</label>
                                <input type="password" name="inputPassword" id="inputPassword" class="form-control mb-4" placeholder="Mot de Passe">

                                <input class="btn btn-lg btn-light btn-block button_all" type="submit" name="inputSubmit" value="S'inscrire">
